...
function btnValid() {
  ...
  if (validator.isValid(creditCardNumber) == true) {
    ...
    alert("Tarjeta Valida  " + document.getElementById("nCard").value);
  } else {
    document.getElementById("validacion").innerHTML =
      "Tu tarjeta sigue bloqueada, vuelve a intentarlo";
    document.getElementById("nCard").value =
      validator.maskify(creditCardNumber);
    alert("Tarjeta Bloqueada  " + document.getElementById("nCard").value);
  }
}
